package com.tongxue.videoplayer.util;
...
public class OrientationUtil {
     ...
     * @param act
     */
    public static void changeOrientation(Activity act, OnScreenChangeListener listener) {
        int targetOrientation = VERTICAL;
        if (getOrientation(act) == VERTICAL) {
            targetOrientation = HORIZONTAL;
        }
        if (listener != null)
            listener.OnScreenChange(targetOrientation);
